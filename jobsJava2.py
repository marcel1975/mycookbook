...
def modification_jdk(jdk_ver, file_name):
...
def the_same_jdk_check(job_name, jdk_ver,file_name):
...
if ( args == 2):
    ...
    the_same_jdk_check(sys.argv[2], sys.argv[4],'config.xml')
    existing_jdk_check(sys.argv[4], my_jdk_list)
    modification_jdk(sys.argv[4],'config.xml')
